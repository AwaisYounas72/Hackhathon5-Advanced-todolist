...
const Header = () => {
    ...
    return (
        ...
        //                 </svg>
        //                 <span className="ml-3 text-xl">Upnote</span>
        //             </a>
  ...
  <header className="text-gray-700 bg-gray-200 body-font flex items-center">
    <div className="container mx-auto flex flex-wrap p-3 flex-col md:flex-row items-center justify-between">
      ...
      <div className="flex space-x-5 items-center mt-4">
        {token ? (
          <Link to={"/login"} className="inline-flex items-center bg-slate-500 text-white border-0 py-2 px-3 focus:outline-none hover:bg-gray-700 rounded text-base md:mt-0" onClick={handleLogout}>
            Logout
          </Link>
        ) : (
